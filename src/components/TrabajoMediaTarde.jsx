// src/components/TrabajoMediaTarde.jsx
import React from 'react';

function TrabajoMediaTarde({ sumarPuntos }) {
    return (
        <div className="section">
            <h2 className="section-title">Trabajo Media Tarde</h2>
...
export default TrabajoMediaTarde;
